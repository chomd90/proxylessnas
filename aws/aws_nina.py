...
if __name__ == "__main__":
            ...
            for seed in [3]:
                try:
                    ...
                    download_prefix_from_s3(
                        ...
                        "nas-theory",
                        filetype=None,
                        local="/media/liamcli/fastfiles/results/icml2020/nina",
                    )
                except:
                    print(prefix)
                    pass

    #for method in ["gdarts"]:
    ...
    #prefix = "/data/eval-space-darts-pcdartseedarts"
    #download_prefix_from_s3(
    #    prefix,
    #    "nas-theory",
    #    filetype=None,
    ...
    # for i in range(1, 4):
    #    for seed in [3, 4, 5, 6]:
    #        for method in ["edarts"]:
    #            try:
    #                prefix = "experiments/darts/search_space_{}/search-{}_space{}_seed{}".format(
    #                    i, method, i, seed
    #                )
    #                download_prefix_from_s3(
    #                    prefix,
